 ...
 * 데이터를 필터링하는 범용 커스텀 훅
 *
 * @param initialData - 필터링할 원본 데이터 배열
 * @param filterKey - 필터링의 기준이 될 객체의 키
 *
 * @returns filteredData - 필터링이 완료된 데이터 배열
 * @returns filterValue - 현재 적용된 필터 값 (기본값: 'All')
 * @returns setFilterValue - 필터 값을 변경하는 함수
 */
